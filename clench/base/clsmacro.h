...
#define CLENCH_NO_COPY_MOVE_CONSTRUCTOR(type) \
...
#define CLENCH_NO_COPY_MOVE_ASSIGN_OPERATOR(type) \
CLENCH_NO_COPY_ASSIGN_OPERATOR(type) \
CLENCH_NO_MOVE_ASSIGN_OPERATOR(type)

#define CLENCH_NO_COPY_MOVE_METHODS(type) \
CLENCH_NO_COPY_MOVE_CONSTRUCTOR(type) \
CLENCH_NO_COPY_MOVE_ASSIGN_OPERATOR(type)
